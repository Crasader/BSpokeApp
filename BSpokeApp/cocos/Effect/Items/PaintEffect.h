...
#ifndef __ShaderDemo__PaintEffect__
#define __ShaderDemo__PaintEffect__

#include "IEffect.h"
#include "cocos2d.h"

class PaintEffect : public IEffect{
...
private:
    ...
    std::vector<cocos2d::Vec2> m_edgeVec;
...
#endif /* defined(__ShaderDemo__PaintEffect__) */
